  ...
  return (
    <main>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <AnimateInView className="text-center space-y-3 mb-8" direction="up" variant="title">
        ...
        {/* Gambar Besar */}
        <AnimateInView direction="right" variant="image">
        ...
        {/* Konten Teks */}
        <div className="mt-6">
          <AnimateInView direction="left" variant="text">
      ...
      {/* Karya Tenun Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <AnimateInView className="text-center mb-12" direction="up" variant="title">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tenunProducts.slice(0, 6).map((product, idx) => (
              <AnimateInView
                key={product.id}
                delay={idx * 80}
        ...
        <AnimateInView className="text-center mt-12" direction="up" variant="cta">
          <Link
            href="/tenun"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {karawitanItems.slice(0, 3).map((item, idx) => (
              <AnimateInView
                key={item.id}
                delay={idx * 100}
                direction={idx % 3 === 0 ? "left" : idx % 3 === 1 ? "up" : "right"}
